...
def run_inspection(cfg: DictConfig):
    ...
    print("")
    print("  MODEL:")
    print("    model=azure_gpt4           # Use GPT-4")
    print("    model=azure_gpt4_mini      # Use GPT-4 Mini")
    print("    model=llama_33             # Use Llama 3.3")
    print("")
    print("  PROMPTING STRATEGY:")
    print("    prompt=standard            # Base prompting (default)")
    print("    prompt=cot                 # Chain-of-Thought reasoning")
    print("    prompt=decomposition       # Multi-step decomposition")
    print("")
    print("  ENTITY LINKING:")
    print("    linking=relik              # Use ReLiK linker")
    print("    linking=rebel              # Use REBEL linker")
    print("    linking=all                # Use ensemble (both)")
    print("")
    print("  RETRIEVAL (Few-shot):")
    print("    retrieval=1shot            # 1 example")
    print("    retrieval=3shot            # 3 examples")
    print("")
    print("  PROMPT OPTIONS:")
    print("    prompt.include_examples=true|false")
    print("    prompt.include_entities=true|false")
    print("    prompt.include_schema_hint=true|false")
    print("    prompt.custom_instruction='Your custom instruction here'")
    print("")
    print("  EXAMPLES:")
    print("    python src/debug/prompts.py prompt=cot linking=relik")
