...
def is_useful_property(label, pid):
    ...
    blacklist = ["id", "identifier", "code", "kennis", "number", "filmportal", "allociné", "imdb", "freebase", "gnd"]
...
def build_schema_index():
    ...
    if not properties:
        ...
        properties = [{"id": "P31", "label": "instance of"}, {"id": "P57", "label": "director"}, {"id": "P161", "label": "cast member"}]

    logger.info(f"Indexing {len(properties)} high-quality properties (Top 5: {[p['label'] for p in properties[:5]]})")
